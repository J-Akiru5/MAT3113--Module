    ...
    >
      ...
      <footer className="relative z-10 flex shrink-0 items-center justify-between bg-navy px-5 py-2">
        ...
        <div className="flex items-center gap-2">
          <svg className="h-3 w-3 text-white/60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} aria-hidden="true">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1">
            <svg className="h-2.5 w-2.5 text-white/60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} aria-hidden="true">
